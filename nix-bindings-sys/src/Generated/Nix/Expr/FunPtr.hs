...
-- __unique:__ @org_cachix_nixbindingshaskell_generatednixexpr_Generated.Nix.Expr_get_nix_eval_state_builder_new@
hs_bindgen_f75a25ecd88954d7 :: IO (RIP.FunPtr ((RIP.Ptr Generated.Nix.Util.Nix_c_context) -> (RIP.Ptr Generated.Nix.Store.Fwd.Store) -> IO (RIP.Ptr Nix_eval_state_builder)))
...
{-| __C declaration:__ @nix_eval_state_builder_new@
    ...
    __exported by:__ @nix_api_expr.h@
-}
nix_eval_state_builder_new :: RIP.FunPtr ((RIP.Ptr Generated.Nix.Util.Nix_c_context) -> (RIP.Ptr Generated.Nix.Store.Fwd.Store) -> IO (RIP.Ptr Nix_eval_state_builder))
...
-- __unique:__ @org_cachix_nixbindingshaskell_generatednixexpr_Generated.Nix.Expr_get_nix_state_create@
hs_bindgen_01c0874745ca8343 :: IO (RIP.FunPtr ((RIP.Ptr Generated.Nix.Util.Nix_c_context) -> (RIP.Ptr (PtrConst.PtrConst RIP.CChar)) -> (RIP.Ptr Generated.Nix.Store.Fwd.Store) -> IO (RIP.Ptr EvalState)))
...
{-| __C declaration:__ @nix_state_create@
    ...
    __exported by:__ @nix_api_expr.h@
-}
nix_state_create :: RIP.FunPtr ((RIP.Ptr Generated.Nix.Util.Nix_c_context) -> (RIP.Ptr (PtrConst.PtrConst RIP.CChar)) -> (RIP.Ptr Generated.Nix.Store.Fwd.Store) -> IO (RIP.Ptr EvalState))
nix_state_create =
